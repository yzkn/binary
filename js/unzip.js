...
(() => {
    ...
    (() => {
        ...
        const fileInput = document.getElementById("unzipFile");
        const encodingInput = document.getElementById("unzipEncoding");
        const fileInputButton = document.getElementById("unzipFile-button");
        const passwordInput = document.getElementById("unzipPassword");
        let fileList = document.getElementById("unzipList");
        let entries;
        let selectedFile;
